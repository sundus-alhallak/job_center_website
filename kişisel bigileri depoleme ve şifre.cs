   ...
   // Bu uygulamada kullanılan uygulama kullanıcı yöneticisini yapılandırın. UserManager, ASP.NET Identity'de tanımlanır ve uygulama tarafından kullanılır.
    public class ApplicationUserManager : UserManager<ApplicationUser>
    {
        ...
        public static ApplicationUserManager Create(IdentityFactoryOptions<ApplicationUserManager> options, IOwinContext context) 
        {
            ...
            // İki faktörlü kimlik doğrulama sağlayıcısını kaydedin. Bu uygulama, kullanıcıyı doğrulamak için bir kod alma adımı olarak Telefon ve E-postaları kullanır.
            // Kendi sağlayıcınızı yazıp buraya takabilirsiniz.
